...
func (ec *EventCreate) SetNillableImageURL(s *string) *EventCreate {
	if s != nil {
		ec.SetImageURL(*s)
	}
	return ec
...
func (ec *EventCreate) SetFeatured(b bool) *EventCreate {
	ec.mutation.SetFeatured(b)
	return ec
}

// SetNillableFeatured sets the "featured" field if the given value is not nil.
func (ec *EventCreate) SetNillableFeatured(b *bool) *EventCreate {
	if b != nil {
		ec.SetFeatured(*b)
	}
	return ec
