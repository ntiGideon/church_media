...
func (su *ServiceUpdate) SetDate(t time.Time) *ServiceUpdate {
	su.mutation.SetDate(t)
	return su
}

// SetNillableDate sets the "date" field if the given value is not nil.
func (su *ServiceUpdate) SetNillableDate(t *time.Time) *ServiceUpdate {
	if t != nil {
		su.SetDate(*t)
	}
	return su
...
func (su *ServiceUpdate) AddAttendanceRecordIDs(ids ...int) *ServiceUpdate {
	su.mutation.AddAttendanceRecordIDs(ids...)
	return su
}

// AddAttendanceRecords adds the "attendance_records" edges to the AttendanceRecord entity.
func (su *ServiceUpdate) AddAttendanceRecords(a ...*AttendanceRecord) *ServiceUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return su.AddAttendanceRecordIDs(ids...)
}
...
func (su *ServiceUpdate) ClearAttendanceRecords() *ServiceUpdate {
	su.mutation.ClearAttendanceRecords()
	return su
}

// RemoveAttendanceRecordIDs removes the "attendance_records" edge to AttendanceRecord entities by IDs.
func (su *ServiceUpdate) RemoveAttendanceRecordIDs(ids ...int) *ServiceUpdate {
	su.mutation.RemoveAttendanceRecordIDs(ids...)
	return su
}

// RemoveAttendanceRecords removes "attendance_records" edges to AttendanceRecord entities.
func (su *ServiceUpdate) RemoveAttendanceRecords(a ...*AttendanceRecord) *ServiceUpdate {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return su.RemoveAttendanceRecordIDs(ids...)
}
...
func (su *ServiceUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if su.mutation.AttendanceRecordsCleared() {
	...
	if nodes := su.mutation.RemovedAttendanceRecordsIDs(); len(nodes) > 0 && !su.mutation.AttendanceRecordsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.AttendanceRecordsTable,
	...
	if nodes := su.mutation.AttendanceRecordsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.AttendanceRecordsTable,
...
// SetDate sets the "date" field.
func (suo *ServiceUpdateOne) SetDate(t time.Time) *ServiceUpdateOne {
	suo.mutation.SetDate(t)
	return suo
}

// SetNillableDate sets the "date" field if the given value is not nil.
func (suo *ServiceUpdateOne) SetNillableDate(t *time.Time) *ServiceUpdateOne {
	if t != nil {
		suo.SetDate(*t)
	}
	return suo
...
// AddAttendanceRecordIDs adds the "attendance_records" edge to the AttendanceRecord entity by IDs.
func (suo *ServiceUpdateOne) AddAttendanceRecordIDs(ids ...int) *ServiceUpdateOne {
	suo.mutation.AddAttendanceRecordIDs(ids...)
	return suo
}

// AddAttendanceRecords adds the "attendance_records" edges to the AttendanceRecord entity.
func (suo *ServiceUpdateOne) AddAttendanceRecords(a ...*AttendanceRecord) *ServiceUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return suo.AddAttendanceRecordIDs(ids...)
}
...
// ClearAttendanceRecords clears all "attendance_records" edges to the AttendanceRecord entity.
func (suo *ServiceUpdateOne) ClearAttendanceRecords() *ServiceUpdateOne {
	suo.mutation.ClearAttendanceRecords()
	return suo
}

// RemoveAttendanceRecordIDs removes the "attendance_records" edge to AttendanceRecord entities by IDs.
func (suo *ServiceUpdateOne) RemoveAttendanceRecordIDs(ids ...int) *ServiceUpdateOne {
	suo.mutation.RemoveAttendanceRecordIDs(ids...)
	return suo
}

// RemoveAttendanceRecords removes "attendance_records" edges to AttendanceRecord entities.
func (suo *ServiceUpdateOne) RemoveAttendanceRecords(a ...*AttendanceRecord) *ServiceUpdateOne {
	ids := make([]int, len(a))
	for i := range a {
		ids[i] = a[i].ID
	}
	return suo.RemoveAttendanceRecordIDs(ids...)
}
...
func (suo *ServiceUpdateOne) sqlSave(ctx context.Context) (_node *Service, err error) {
	...
	if suo.mutation.AttendanceRecordsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.AttendanceRecordsTable,
	...
	if nodes := suo.mutation.RemovedAttendanceRecordsIDs(); len(nodes) > 0 && !suo.mutation.AttendanceRecordsCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.AttendanceRecordsTable,
	...
	if nodes := suo.mutation.AttendanceRecordsIDs(); len(nodes) > 0 {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.O2M,
			Inverse: false,
			Table:   service.AttendanceRecordsTable,
