...
func (m *SubscribeMutation) SetID(id int) {
	m.id = &id
}
...
// SetEmail sets the "email" field.
func (m *SubscribeMutation) SetEmail(s string) {
	m.email = &s
}

// Email returns the value of the "email" field in the mutation.
func (m *SubscribeMutation) Email() (r string, exists bool) {
	v := m.email
	if v == nil {
		return
	}
...
// OldEmail returns the old "email" field's value of the Subscribe entity.
// If the Subscribe object wasn't provided to the builder, the object is fetched from the database.
// An error is returned if the mutation operation is not UpdateOne, or the database query fails.
func (m *SubscribeMutation) OldEmail(ctx context.Context) (v string, err error) {
	if !m.op.Is(OpUpdateOne) {
		return v, errors.New("OldEmail is only allowed on UpdateOne operations")
	}
	if m.id == nil || m.oldValue == nil {
...
// ResetEmail resets all changes to the "email" field.
func (m *SubscribeMutation) ResetEmail() {
	m.email = nil
}
...
func (m *SubscribeMutation) Fields() []string {
	...
	if m.email != nil {
		fields = append(fields, subscribe.FieldEmail)
	}
	if m.created_at != nil {
